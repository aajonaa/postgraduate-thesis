...
针对上述挑战，本章从搜索策略自适应演化和采样决策可解释性两个方面展开研究。一方面，将多臂赌博机机制引入搜索框架，利用实时环境反馈引导搜索模式的动态切换\cite{slivkins2019introduction}；另一方面，借鉴SHAP思想\cite{nohara2022explanation}构建特征重要性评估组件，提出兼顾优化潜力与决策依据的可解释不确定性准则。
