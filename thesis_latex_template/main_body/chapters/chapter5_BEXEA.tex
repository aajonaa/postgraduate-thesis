...
收敛轨迹（图\ref{fig:bexea_Oil_Exp_Figure}）表明，BEXEA在搜索初期就能够建立较好的优化基础。进入中后期后，得益于MAB机制对搜索停滞状态的动态响应，算法仍能持续向更优区域逼近，并在有限评估预算内取得较好的经济收益。
