...
最后，精英引导变异策略的伪代码如\textbf{Algorithm 1}所示，以直观地传达其实现细节。
...
\textbf{If} $BestX$ updated \\ \hline 
    U$p$date $s$ by Eq. \eqref{ibsa_eq_10}; \\ \hline 
\textbf{End If} \\ \hline 
\textbf{If} $flag$ updated \\ \hline 
    Update $OldX$ by Eq. \eqref{ibsa_eq_12}; \\ \hline 
\textbf{End} \\ \hline 
$OldX\ =\ permuting(OldX)$; \\ \hline 
Calculate $p$ by Eq. \eqref{ibsa_eq_11}; \\ \hline 
\textbf{If} p $\mathrm{>}$ rand \\ \hline 
    Update $flag$ by Eq. \eqref{ibsa_eq_13}; \\ \hline 
    Update \textit{m} by Eq. \eqref{ibsa_eq_14}; \\ \hline 
    \textbf{For} $i\ =\ 1:N$ \\ \hline 
        \textbf{If} $i\ \sim =\ \boldsymbol{BestX}\boldsymbol{\_}\boldsymbol{idx}$ \\ \hline 
            Update $map$ by Eq. \eqref{ibsa_eq_6}; \\ \hline 
            Update Mutant by Eq. \eqref{ibsa_eq_15}; \\ \hline 
        \textbf{Else} \\ \hline 
            Update $Mutant$ by Eq. \eqref{ibsa_eq_16}; \\ \hline 
        \textbf{End If} \\ \hline 
    \textbf{End} \textbf{For} \\ \hline 
    \textbf{Else} \\ \hline 
\textbf{        }Update flag by Eq. \eqref{ibsa_eq_13}; \\ \hline 
\textbf{        For }$i\ =\ 1:N$ \\ \hline 
            Update $map$ by Eq. \eqref{ibsa_eq_7}; \\ \hline 
            Update Mutant by Eq. \eqref{ibsa_eq_5} and Eq. \eqref{ibsa_eq_8}; \\ \hline 
        \textbf{End For} \\ \hline 
    \textbf{End If} \\ \hline 
...
为了说明这些变化，IBSA的过程细节编码在伪代码中，命名为\textbf{Algorithm 2}，而算法步骤和决策点的综合流程图如图\ref{fig:flowchart_IBSA}所示。这些工具旨在提供对IBSA操作框架及其对BSA改进的清晰直观理解。
...
\textbf{    Carry out Elite Leading Mutation Strategy;} \\ \hline 
    ...
    Update $X$ by Eq. \eqref{ibsa_eq_9}; \\ \hline 
    $t\ =\ t\ +\ 1$; \\ \hline 
...
SCA & $a=2$CS \\ \hline 
$m\ =\ 10;\ P\alpha\ =\ 0.25$WOA & $a=\left[0,2\right]$GWO \\ \hline
...
\begin{longtable}{|p{0.32in}|p{0.40in}|p{0.56in}|p{0.56in}|p{0.56in}|p{0.56in}|p{0.56in}|p{0.56in}|p{0.56in}|p{0.56in}|p{0.56in}|p{0.56in}|p{0.56in}|p{0.56in}|p{0.56in}|} \hline 
\multicolumn{13}{|p{7.3in}|}{\textbf{Table }2\textbf{. }Comparison results of IBSA and the basic MAs\textbf{}} & \textbf{} & \textbf{} \\ \hline 
...
\scriptsize
\setlength{\tabcolsep}{1pt}
\begin{longtable}{|p{0.34in}|p{0.62in}|p{0.20in}|p{0.62in}|p{0.20in}|p{0.62in}|p{0.20in}|p{0.62in}|p{0.20in}|p{0.62in}|p{0.20in}|p{0.62in}|p{0.20in}|} \hline 
\multicolumn{13}{|c|}{\textbf{Table }3\textbf{. }P-value of Wilcoxon test obtained from comparison with basic MAs} \\ \hline 
Fun & \multicolumn{2}{|c|}{IBSA vs BSA} & \multicolumn{2}{|c|}{IBSA vs SMA} & \multicolumn{2}{|c|}{IBSA vs DE} & \multicolumn{2}{|c|}{IBSA vs PSO} & \multicolumn{2}{|c|}{IBSA vs GSA} & \multicolumn{2}{|c|}{IBSA vs BA} \\ \hline 
 & p-Value & Sign & p-Value & Sign & p-Value & Sign & p-Value & Sign & p-Value & Sign & p-Value & Sign \\ \hline 
...
Fun & \multicolumn{2}{|c|}{IBSA vs SCA} & \multicolumn{2}{|c|}{IBSA vs CS} & \multicolumn{2}{|c|}{IBSA vs WOA} & \multicolumn{2}{|c|}{IBSA vs GWO} & \multicolumn{2}{|c|}{IBSA vs MFO} & \multicolumn{2}{|c|}{IBSA vs HHO} \\ \hline 
 & p-Value & Sign & p-Value & Sign & p-Value & Sign & p-Value & Sign & p-Value & Sign & p-Value & Sign \\ \hline 
...
\scriptsize
\setlength{\tabcolsep}{1pt}
\begin{longtable}{|p{0.32in}|p{0.40in}|p{0.58in}|p{0.58in}|p{0.58in}|p{0.58in}|p{0.58in}|p{0.58in}|p{0.58in}|p{0.58in}|p{0.58in}|p{0.58in}|p{0.58in}|p{0.58in}|} \hline 
\multicolumn{13}{|p{7.2in}|}{\textbf{Table }4\textbf{. }Comparison results of IBSA and the advance MAs\textbf{}} & \textbf{} \\ \hline 
...
\begin{longtable}{|p{0.3in}|p{0.2in}|p{0.3in}|p{0.2in}|p{0.1in}|p{0.3in}|p{0.3in}|p{0.2in}|p{0.6in}|p{0.1in}|p{0.2in}|p{0.3in}|p{0.3in}|p{0.1in}|p{0.1in}|p{0.4in}|p{0.2in}|p{0.1in}|p{0.1in}|p{0.5in}|p{0.2in}|p{0.2in}|} \hline 
...
\small
\begin{tabular}{|p{1.45in}|p{0.85in}|p{0.95in}|p{0.75in}|} \hline 
\multicolumn{4}{|p{3.8in}|}{\textbf{Table }6\textbf{.} Description of the datasets used} \\ \hline 
...
\small
\begin{tabular}{|p{1.2in}|p{3.3in}|} \hline 
\multicolumn{2}{|p{4.3in}|}{\textbf{Table }7\textbf{.} Setup of control parameter} \\ \hline 
Algorithm & Other parameters \\ \hline 
...
\scriptsize
\setlength{\tabcolsep}{1pt}
\begin{longtable}{|p{1.15in}|p{0.42in}|p{0.56in}|p{0.56in}|p{0.56in}|p{0.56in}|p{0.56in}|p{0.56in}|p{0.56in}|p{0.56in}|p{0.56in}|} \hline 
\multicolumn{10}{|p{6.2in}|}{\textbf{Table }8\textbf{. }Comparison between bIBSA and other algorithms on average fitness values\textbf{}} & \textbf{} \\ \hline 
...
\setlength{\tabcolsep}{1pt}
\begin{longtable}{|p{1.15in}|p{0.42in}|p{0.56in}|p{0.56in}|p{0.56in}|p{0.56in}|p{0.56in}|p{0.56in}|p{0.56in}|p{0.56in}|p{0.56in}|} \hline 
\multicolumn{10}{|p{6.2in}|}{\textbf{Table }9\textbf{. }Comparison between bIBSA and other algorithms on average of selected features\textbf{}} & \textbf{} \\ \hline 
\textbf{Function} & \textbf{Metric} & \textbf{bIBSA} & \textbf{BMFO} & \textbf{BGWO} & \textbf{BGSA} & \textbf{BPSO} & \textbf{BALO} & \textbf{BBA} & \textbf{BSSA} & \textbf{BWOA} \\ \hline 
...
\setlength{\tabcolsep}{1pt}
\begin{longtable}{|p{1.15in}|p{0.42in}|p{0.56in}|p{0.56in}|p{0.56in}|p{0.56in}|p{0.56in}|p{0.56in}|p{0.56in}|p{0.56in}|p{0.56in}|} \hline 
\multicolumn{10}{|p{6.2in}|}{\textbf{Table }10\textbf{. }Comparison between bIBSA and other algorithms on average of error rate\textbf{}} & \textbf{} \\ \hline 
\textbf{Function} & \textbf{Metric} & \textbf{bIBSA} & \textbf{BMFO} & \textbf{BGWO} & \textbf{BGSA} & \textbf{BPSO} & \textbf{BALO} & \textbf{BBA} & \textbf{BSSA} & \textbf{BWOA} \\ \hline 
...
\setlength{\tabcolsep}{1pt}
\begin{longtable}{|p{1.15in}|p{0.42in}|p{0.56in}|p{0.56in}|p{0.56in}|p{0.56in}|p{0.56in}|p{0.56in}|p{0.56in}|p{0.56in}|p{0.56in}|} \hline 
\multicolumn{10}{|p{6.2in}|}{\textbf{Table }11\textbf{. }Comparison between bIBSA and other algorithms on average of run time\textbf{}} & \textbf{} \\ \hline 
\textbf{Function} & \textbf{Metric} & \textbf{bIBSA} & \textbf{BMFO} & \textbf{BGWO} & \textbf{BGSA} & \textbf{BPSO} & \textbf{BALO} & \textbf{BBA} & \textbf{BSSA} & \textbf{BWOA} \\ \hline 
